...
void keep_example(workspace& all, OjaNewton& /* ON */, example& ec) { output_and_account_example(all, ec); }
...
base_learner* OjaNewton_setup(options_i& options, workspace& all)
{
