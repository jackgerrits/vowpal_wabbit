...
struct Namespace
{
  ...
  void AddFeature(workspace* all, const char* str)
  {
  ...
  void AddFeature(workspace* all, const char* key, const char* value)
  {
...
template <bool audit>
void push_ns(example* ex, const char* ns, std::vector<Namespace<audit>>& namespaces, workspace& all)
{
  Namespace<audit> n;
