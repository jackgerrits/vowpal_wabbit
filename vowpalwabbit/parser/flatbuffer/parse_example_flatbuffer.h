...
public:
  ...
  bool parse_examples(workspace* all, v_array<example*>& examples, uint8_t* buffer_pointer = nullptr);
...
private:
  ...
  void parse_namespaces(workspace* all, example* ae, const Namespace* ns);
  void parse_features(workspace* all, features& fs, const Feature* feature, const flatbuffers::String* ns);
