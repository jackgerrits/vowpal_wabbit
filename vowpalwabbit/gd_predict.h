...
inline void foreach_feature(WeightsT& weights, bool ignore_some_linear, std::array<bool, NUM_NAMESPACES>& ignore_linear,
    const std::vector<std::vector<VW::strong_namespace_index>>& interactions, bool permutations, example_predict& ec, DataT& dat,
...
inline float inline_predict(WeightsT& weights, bool ignore_some_linear, std::array<bool, NUM_NAMESPACES>& ignore_linear,
    const std::vector<std::vector<VW::strong_namespace_index>>& interactions, bool permutations, example_predict& ec,
    float initial = 0.f)
{
