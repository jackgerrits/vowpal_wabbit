...
void eval_count_of_generated_ft_naive(
    workspace& all, example_predict& ec, size_t& new_features_cnt, float& new_features_value)
{
...
{
  auto& vw = *vw::initialize("--quiet --interactions :: --noconstant", nullptr, false, nullptr, nullptr);
