...
std::string get_x_string_fts_no_label(int feature_size, size_t action_index)
{
  std::stringstream ss;
  ss << " | ";
...
std::string get_x_string_fts_multi_ex(int feature_size, size_t actions, bool shared, bool label, size_t start_index)
{
